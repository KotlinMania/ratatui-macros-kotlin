...
kotlin {
    ...
    val xcf = XCFramework("RatatuiMacros")
    ...
    swiftExport {
        moduleName = "RatatuiMacros"
        flattenPackage = "io.github.kotlinmania.ratatuimacros"
    }

    android {
        namespace = "io.github.kotlinmania.ratatuimacros"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "ratatui-macros-kotlin", version.toString())

    pom {
        name.set("ratatui-macros-kotlin")
        description.set("Kotlin Multiplatform port of ratatui/ratatu - Macros for Ratatui")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/ratatui-macros-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/ratatui-macros-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/ratatui-macros-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/ratatui-macros-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.ratatuimacros.codeql
