...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RatatuiMacros.swiftmodule/`
...
//      `import RatatuiMacros` above would fail at compile time.
//
//   2. The static archive `libRatatuiMacros.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RatatuiMacros" }` and
//      `flattenPackage = "io.github.kotlinmania.ratatuimacros"` configuration in
...
//      via the `RatatuiMacrosLibrary` product.
//
...
final class RatatuiMacrosExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "RatatuiMacros swift module imported cleanly")
    }
}
