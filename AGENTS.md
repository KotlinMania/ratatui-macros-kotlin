...
This file is the quick-reference operating contract for ratatui-macros-kotlin. The longer
...
ratatui-macros-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ratatui-macros`](https://crates.io/crates/ratatui-macros). Upstream Rust is the behavioral oracle while the
